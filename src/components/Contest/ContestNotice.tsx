...
function ContestNotice() {
  return (
    <S.ContestNotice>
      ...
      <S.NoticeList>
        <S.NoticeListTitle>[사진 주제]</S.NoticeListTitle>
      ...
      <S.NoticeList>
        <S.NoticeListTitle>🗳️ 투표 방법</S.NoticeListTitle>
        <div>투표 기간: 5월 15일(금) 00:00 ~ 17:00</div>
        <div> 투표 대상: 덕성여자대학교 재학생/휴학생</div>
      </S.NoticeList>
      <S.NoticeList>
        <S.NoticeListTitle>[참여 방법]</S.NoticeListTitle>
        <div>1. 후보 사진 확인</div>
        <div>
      ...
      <S.NoticeList>
        <S.NoticeListTitle>🏆 결과 발표</S.NoticeListTitle>
        <div>일시: 5월 15일(금) 18:20 ~ 18:50</div>
        <div>장소: 영근터 무대</div>
        <div>여러분의 투표 결과를 바탕으로 최종 수상작이 발표됩니다!</div>
      </S.NoticeList>
      <S.NoticeList>
        <S.NoticeListTitle>🎁 상품 안내</S.NoticeListTitle>
